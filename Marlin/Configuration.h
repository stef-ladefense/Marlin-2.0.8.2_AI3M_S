...
#define STRING_CONFIG_H_AUTHOR "(Stef_ladefense, default config)" // Who made the changes.
...
// Define for Drivers installed (Comment for stock drivers). See line 794 for type
#define I3MEGA_HAS_TMC
 ...
 */
//#define Z_MIN_PROBE_PIN 2 // Pin 2 is the RAMPS default
